...
- (struct { double x1; double x2; })waveformSelectionOverlay:(RCWaveformSelectionOverlay *)arg1 willChangeSelectedTimeRange:(struct { double x1; double x2; })arg2 isTrackingMin:(bool)arg3 isTrackingMax:(bool)arg4;
