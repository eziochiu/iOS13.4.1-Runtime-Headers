...
- (oneway void)importRecordingWithSourceAudioURL:(void *)arg1 name:(void *)arg2 date:(void *)arg3 importCompletionBlock:(void *)arg4; // needs 4 arg types, found 10: NSSecurityScopedURLWrapper *, NSString *, NSDate *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSURL *, NSError *, void*
