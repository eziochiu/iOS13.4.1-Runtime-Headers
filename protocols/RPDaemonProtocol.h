...
- (oneway void)macApplicationDidBecomeActiveWithContextID:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 7: unsigned int, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
- (oneway void)macApplicationDidResignActive;
- (oneway void)pauseRecording;
- (oneway void)reportCameraUsage:(long long)arg1;
- (oneway void)resumeRecordingWithWindowLayerContextID:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 7: unsigned int, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
