...
- (void)snapshotJournalsForPayloadClassIDs:(void *)arg1 reply:(void *)arg2; // needs 2 arg types, found 6: NSSet *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*
