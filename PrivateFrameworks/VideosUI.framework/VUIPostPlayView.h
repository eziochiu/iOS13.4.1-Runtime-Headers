...
- (id)episodeImageView;
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 andEpisodeArtworkURLStringFormat:(id)arg2 andTitle:(id)arg3;
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 andTVImageProxy:(id)arg2 andTitle:(id)arg3;
- (void)layoutSubviews;
- (id)nextEpisodeLabel;
