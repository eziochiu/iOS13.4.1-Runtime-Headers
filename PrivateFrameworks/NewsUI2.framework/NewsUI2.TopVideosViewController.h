...
@interface NewsUI2.TopVideosViewController : UIViewController <TSBlueprintInspectable, TSTabBarSplitViewAutoObserver, TSVideoGroupViewControllerType, TUDeselectable, TUKeyCommandTraversable, TUPluggable> {
