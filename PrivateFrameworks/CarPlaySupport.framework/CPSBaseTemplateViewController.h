...
@interface CPSBaseTemplateViewController : UIViewController <BSInvalidatable, CPBaseTemplateProviding, CPSBaseTemplateViewController, CPSButtonDelegate, UIGestureRecognizerDelegate> {
