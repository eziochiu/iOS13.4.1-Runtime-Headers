...
- (struct CGSize { double x1; double x2; })estimatedSizeOfSectionForAssetCollection:(id)arg1 isCurated:(bool)arg2 numberOfAssets:(long long)arg3 referenceSize:(struct CGSize { double x1; double x2; })arg4 zoomLevel:(long long)arg5;
