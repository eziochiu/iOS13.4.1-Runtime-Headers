...
+ (double)_baselineDistanceForFontSet:(long long)arg1 specSet:(long long)arg2 variant:(long long)arg3 size:(struct CGSize { double x1; double x2; })arg4 shouldScale:(bool)arg5;
...
+ (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })_paddingForFontSet:(long long)arg1 specSet:(long long)arg2 variant:(long long)arg3 horizontalMargin:(double)arg4 width:(double)arg5 shouldScale:(bool)arg6;
...
+ (id)_textAttributesForFontSet:(long long)arg1 specSet:(long long)arg2 labelKind:(long long)arg3 withTitleFontName:(id)arg4 variant:(long long)arg5 size:(struct CGSize { double x1; double x2; })arg6 shouldScale:(bool)arg7;
...
- (void).cxx_destruct;
- (id)_initWithIdentifier:(struct PXMemoryFontsSpecIdentifier { long long x1; long long x2; long long x3; struct CGSize { double x_4_1_1; double x_4_1_2; } x4; double x5; bool x6; })arg1 titleFontName:(id)arg2;
