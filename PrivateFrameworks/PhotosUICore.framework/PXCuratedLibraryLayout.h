...
@interface PXCuratedLibraryLayout : PXGSplitLayout <PXAssetsDataSourceManagerObserver, PXChangeObserver, PXCuratedLibraryViewModelPresenter, PXGAnchorDelegate, PXGNamedImageSource, PXLibrarySummaryDataSource> {
