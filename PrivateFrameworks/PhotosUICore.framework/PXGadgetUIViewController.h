...
@interface PXGadgetUIViewController : UICollectionViewController <PXChangeObserver, PXContentUnavailablePlaceholderManagerDelegate, PXGadgetAnchorHelperDelegate, PXGadgetCollectionViewLayoutDelegate, PXGadgetDelegate, PXGadgetNavigationHelperDelegate, PXSectionedDataSourceManagerObserver, UICollectionViewDataSourcePrefetching, UICollectionViewDelegateFlowLayout, UICollectionViewDropDelegate, UIContextMenuInteractionDelegate> {
