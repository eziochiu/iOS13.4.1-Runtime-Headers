...
- (id)runPerformanceTestWithConfiguration:(id)arg1 update:(id /* block */)arg2 error:(out id*)arg3;
- (id)runPerformanceTestWithConfiguration:(id)arg1 update:(id /* block */)arg2 reply:(id /* block */)arg3;
