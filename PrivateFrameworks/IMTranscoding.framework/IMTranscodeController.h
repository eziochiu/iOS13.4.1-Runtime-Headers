...
- (bool)_connect;
- (void)_disconnected;
- (void)_generatePreview:(id)arg1 previewURL:(id)arg2 constraints:(struct IMPreviewConstraints { double x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; double x3; bool x4; })arg3 completionBlock:(id /* block */)arg4;
