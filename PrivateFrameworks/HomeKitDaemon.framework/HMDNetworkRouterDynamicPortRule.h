...
@interface HMDNetworkRouterDynamicPortRule : NSObject <HMDNetworkRouterLANRule, HMDTLVProtocol, NSCopying> {
...
@property (nonatomic, retain) HMDTLVUnsignedNumberValue *flags;
