...
- (void)_readCharacteristicValuesForAccessories:(id)arg1 readRequestMap:(id)arg2 responseTuples:(id)arg3 requestMessage:(id)arg4 viaDevice:(id)arg5 logEventSession:(id)arg6 completionHandler:(id /* block */)arg7;
...
- (void)_writeCharacteristicValuesForAccessories:(id)arg1 writeRequestMap:(id)arg2 responseTuples:(id)arg3 requestMessage:(id)arg4 viaDevice:(id)arg5 source:(unsigned long long)arg6 logEventSession:(id)arg7 completionHandler:(id /* block */)arg8;
- (id)accessories;
- (id)accessoryBrowser;
...
- (void)readCharacteristicValues:(id)arg1 identifier:(id)arg2 isSPIEntitled:(bool)arg3 source:(unsigned long long)arg4 logEventSession:(id)arg5 withCompletionHandler:(id /* block */)arg6;
...
- (id)workQueue;
- (void)writeCharacteristicValues:(id)arg1 source:(unsigned long long)arg2 identifier:(id)arg3 logEventSession:(id)arg4 withCompletionHandler:(id /* block */)arg5;
