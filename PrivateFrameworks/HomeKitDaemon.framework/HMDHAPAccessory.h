...
@property (nonatomic, readonly, copy) NSArray *awdHAPServicesList;
@property (nonatomic, readonly, copy) AWDHomeKitHAPService *awdPrimaryHAPService;
...
- (void)_evaluateLocalOperation:(long long)arg1 state:(id)arg2 logEventSession:(id)arg3 completion:(id /* block */)arg4;
...
- (void)_performOperation:(long long)arg1 linkType:(long long)arg2 logEventSession:(id)arg3 operationBlock:(id /* block */)arg4 errorBlock:(id /* block */)arg5;
...
- (void)_readCharacteristicValues:(id)arg1 hapAccessory:(id)arg2 source:(unsigned long long)arg3 queue:(id)arg4 logEventSession:(id)arg5 completionHandler:(id /* block */)arg6;
...
- (void)_readCharacteristicValues:(id)arg1 localOperationRequired:(bool)arg2 source:(unsigned long long)arg3 queue:(id)arg4 logEventSession:(id)arg5 completionHandler:(id /* block */)arg6 errorBlock:(id /* block */)arg7;
...
- (void)_writeCharacteristicValues:(id)arg1 hapAccessory:(id)arg2 source:(unsigned long long)arg3 queue:(id)arg4 logEventSession:(id)arg5 completionHandler:(id /* block */)arg6;
...
- (void)_writeCharacteristicValues:(id)arg1 localOperationRequired:(bool)arg2 source:(unsigned long long)arg3 queue:(id)arg4 logEventSession:(id)arg5 completionHandler:(id /* block */)arg6 errorBlock:(id /* block */)arg7;
...
- (id)awdHAPServicesList;
- (id)awdPrimaryHAPService;
...
- (void)readCharacteristicValues:(id)arg1 source:(unsigned long long)arg2 queue:(id)arg3 logEventSession:(id)arg4 completionHandler:(id /* block */)arg5;
...
- (void)writeCharacteristicValues:(id)arg1 source:(unsigned long long)arg2 queue:(id)arg3 logEventSession:(id)arg4 completionHandler:(id /* block */)arg5;
