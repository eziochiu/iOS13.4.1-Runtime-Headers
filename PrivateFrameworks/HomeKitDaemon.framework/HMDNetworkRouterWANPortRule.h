...
@interface HMDNetworkRouterWANPortRule : NSObject <HMDNetworkRouterWANRule, HMDTLVProtocol, NSCopying> {
...
@property (nonatomic, retain) HMDTLVUnsignedNumberValue *hostPortEnd;
@property (nonatomic, retain) HMDTLVUnsignedNumberValue *hostPortStart;
