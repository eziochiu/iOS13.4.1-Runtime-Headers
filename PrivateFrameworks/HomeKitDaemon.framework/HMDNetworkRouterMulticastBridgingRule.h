...
@interface HMDNetworkRouterMulticastBridgingRule : NSObject <HMDNetworkRouterLANRule, HMDTLVProtocol, NSCopying> {
...
@property (nonatomic, retain) HMDTLVUnsignedNumberValue *destinationPort;
