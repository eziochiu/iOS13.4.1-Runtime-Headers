...
@interface HMDNetworkRouterStaticPortRule : NSObject <HMDNetworkRouterLANRule, HMDTLVProtocol, NSCopying> {
...
@property (nonatomic, retain) HMDTLVUnsignedNumberValue *destinationPortEnd;
@property (nonatomic, retain) HMDTLVUnsignedNumberValue *destinationPortStart;
