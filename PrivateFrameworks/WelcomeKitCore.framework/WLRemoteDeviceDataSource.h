...
- (void)_performDownloadRequest:(id)arg1 numberOfRetriesAllowed:(unsigned long long)arg2 startDate:(id)arg3 fileAccessor:(id /* block */)arg4 completion:(id /* block */)arg5;
- (void)_performRequest:(id)arg1 numberOfRetriesAllowed:(unsigned long long)arg2 preventRetriesAfterTaskExceedsDuration:(bool)arg3 taskDurationLimit:(double)arg4 startDate:(id)arg5 completionHandler:(id /* block */)arg6;
