...
- (void).cxx_destruct;
- (void)_downloadFileInMultipleSegmentsFromSource:(id)arg1 forMigrator:(id)arg2 summary:(id)arg3 account:(id)arg4 segmentCompletion:(id /* block */)arg5 completion:(id /* block */)arg6;
- (void)_downloadSegmentsFromSource:(id)arg1 forMigrator:(id)arg2 startingAtByteLocation:(unsigned long long)arg3 ofSummary:(id)arg4 account:(id)arg5 toFileHandle:(id)arg6 segmentCompletion:(id /* block */)arg7 completion:(id /* block */)arg8;
