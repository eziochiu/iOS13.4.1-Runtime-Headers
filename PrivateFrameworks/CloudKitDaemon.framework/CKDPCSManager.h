...
- (void)_createPCSFromData:(id)arg1 ofType:(unsigned long long)arg2 usingPCSServiceType:(unsigned long long)arg3 withSyncKeyRegistryRetry:(bool)arg4 completionHandler:(id /* block */)arg5;
- (bool)_isWhitelistedKeyRollingContainerIdentifier:(id)arg1;
- (void)_lockedBoundaryKeyDataWithCompletionHandler:(id /* block */)arg1;
- (void)_locked_createPCSFromData:(id)arg1 ofType:(unsigned long long)arg2 usingPCSServiceType:(unsigned long long)arg3 withSyncKeyRegistryRetry:(bool)arg4 completionHandler:(id /* block */)arg5;
