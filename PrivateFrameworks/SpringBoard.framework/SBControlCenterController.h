...
@interface SBControlCenterController : NSObject <CCUIHostStatusBarStyleProvider, CCUIModularControlCenterOverlayViewControllerDelegate, CSCoverSheetOverlaying, CSExternalAppearanceProviding, CSExternalBehaviorProviding, CSExternalPresentationProviding, SBBarSwipeAffordanceDelegate, SBBarSwipeAffordanceObserver, SBFIdleTimerBehaviorProviding, SBGrabberTongueDelegate, SBIdleTimerProviding, SBIndirectPanGestureRecognizerOrientationProviding, SBReachabilityObserver, SBSystemGestureRecognizerDelegate, UIGestureRecognizerDelegate> {
