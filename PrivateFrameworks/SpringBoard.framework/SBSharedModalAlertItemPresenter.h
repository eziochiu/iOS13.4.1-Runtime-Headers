...
@interface SBSharedModalAlertItemPresenter : NSObject <SBBarSwipeAffordanceDelegate, SBBarSwipeAffordanceObserver, SBHomeGestureParticipantDelegate, SBModalViewControllerStackDelegate, SBReachabilityObserver, UIAlertControllerCoordinatedActionPerforming, _SBAlertControllerDelegate> {
