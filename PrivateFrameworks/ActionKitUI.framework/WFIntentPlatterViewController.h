...
@interface WFIntentPlatterViewController : UIViewController <APUILongLookViewControllerDataSource, APUILongLookViewControllerDelegate, CRKCardPresentationDelegate, PLClickPresentationInteractionManagerDelegate, PLClickPresentationInteractionPresenting, WFIntentViewController> {
