...
@property (setter=_setLowLightAutoDisabledReasons:, nonatomic) unsigned long long _lowLightAutoDisabledReasons;
@property (setter=_setLowLightDurationMapping:, nonatomic) struct { double x1; double x2; } _lowLightDurationMapping;
@property (setter=_setLowLightMode:, nonatomic) long long _lowLightMode;
...
+ (struct { long long x1; long long x2; long long x3; long long x4; bool x5; long long x6; long long x7; long long x8; })_dynamicShutterSettingsForCameraMode:(long long)arg1 timerDuration:(long long)arg2 usingCreativeCameraControls:(bool)arg3;
