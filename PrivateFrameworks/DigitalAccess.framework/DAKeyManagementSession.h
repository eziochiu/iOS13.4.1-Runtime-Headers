...
@interface DAKeyManagementSession : DASession <DAKeyBindingAttestationUpdate, DAKeyTrackingUpdate, KmlSessionCallbacks, NSSecureCoding>
...
- (id)getManagementProxy:(id /* block */)arg1;
