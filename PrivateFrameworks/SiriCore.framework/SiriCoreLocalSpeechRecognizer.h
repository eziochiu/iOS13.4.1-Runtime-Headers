...
- (void)startSpeechRecognitionWithLanguage:(id)arg1 interactionIdentifier:(id)arg2 task:(id)arg3 context:(id)arg4 narrowband:(bool)arg5 detectUtterances:(bool)arg6 maximumRecognitionDuration:(double)arg7 farField:(bool)arg8 secureOfflineOnly:(bool)arg9 censorSpeech:(bool)arg10 originalAudioFileURL:(id)arg11 overrides:(id)arg12 modelOverrideURL:(id)arg13 didStartHandler:(id /* block */)arg14;
