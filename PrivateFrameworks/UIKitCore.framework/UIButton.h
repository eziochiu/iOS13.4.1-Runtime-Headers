...
@property (setter=_sf_setCursorStyleProvider:, nonatomic, copy) id /* block */ _sf_cursorStyleProvider;
...
- (id /* block */)_sf_cursorStyleProvider;
- (void)_sf_setCursorStyleProvider:(id /* block */)arg1;
