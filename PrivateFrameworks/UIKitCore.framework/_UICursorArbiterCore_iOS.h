...
@property (nonatomic, retain) _UIPortalView *cursorPortalView;
@property (nonatomic, copy) NSMapTable *cursorRegionToMatchMoveSourceMap;
...
- (void)_prepareContentMatchMoveSourceForCursorRegion:(id)arg1 completion:(id /* block */)arg2;
...
- (id)cursorPortalView;
- (id)cursorRegionToMatchMoveSourceMap;
...
- (void)setCursorPortalView:(id)arg1;
- (void)setCursorRegionToMatchMoveSourceMap:(id)arg1;
