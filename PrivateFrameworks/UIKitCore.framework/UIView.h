...
@property (nonatomic) bool amsuid_useContinuousCorners;
...
- (bool)amsuid_useContinuousCorners;
- (void)setAmsuid_useContinuousCorners:(bool)arg1;
...
- (id)hb_addCompactConstraint:(id)arg1 metrics:(id)arg2 views:(id)arg3;
- (id)hb_addCompactConstraints:(id)arg1 metrics:(id)arg2 views:(id)arg3;
- (void)hb_addConstraintsWithVisualFormat:(id)arg1 options:(unsigned long long)arg2 metrics:(id)arg3 views:(id)arg4;
