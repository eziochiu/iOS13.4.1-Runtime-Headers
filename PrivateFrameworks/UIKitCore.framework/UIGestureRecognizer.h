...
@interface UIGestureRecognizer : NSObject <TSDGesture, _UIDraggable, _UIExcludable, _UIForceLevelClassifierDelegate, _UIHoverable, _UIScrollable, _UITouchable, _UITransformable> {
