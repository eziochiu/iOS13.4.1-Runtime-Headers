...
@interface CSVoiceTriggerSecondPass : NSObject <CSAudioServerCrashMonitorDelegate, CSAudioStreamProvidingDelegate, CSKeywordAnalyzerNDAPIScoreDelegate, CSKeywordAnalyzerNDEAPIScoreDelegate, CSKeywordAnalyzerQuasarScoreDelegate, CSMediaPlayingMonitorDelegate, CSSelfTriggerDetectorDelegate, CSSpIdVTTextDependentSpeakerRecognizerDelegate, CSVoiceTriggerEnabledMonitorDelegate, CSVolumeMonitorDelegate> {
    NSString * _UUID;
...
@property (nonatomic) bool isSATDetectionRunning;
...
@property (nonatomic) bool kwdRejectCleanupPending;
@property (nonatomic) unsigned long long kwdRejectCleanupSecondPassResult;
@property (nonatomic, retain) NSUUID *kwdRejectCleanupToken;
...
@property (nonatomic, retain) NSMutableDictionary *lastVoiceTriggerEventInfo;
...
@property (nonatomic) bool skipTdsrProc;
...
@property (nonatomic, retain) CSSpIdVTTextDependentSpeakerRecognizer *tdsrAnalyzer;
@property (nonatomic) bool tdsrResultPending;
@property (nonatomic, retain) NSDate *tdsrStartTime;
@property (nonatomic, retain) NSUUID *tdsrTimeoutToken;
...
- (void)setKwdRejectCleanupToken:(id)arg1;
...
- (void)setTdsrStartTime:(id)arg1;
- (void)setTdsrTimeoutToken:(id)arg1;
