...
@property (nonatomic, retain) JTCompositionTrackGroup *alternateTrackGroup;
...
@property (nonatomic) JTClip *clip;
@property (nonatomic) bool clipRequiresCA;
@property (nonatomic, retain) JTCompositionTrackGroup *currentTrackGroup;
