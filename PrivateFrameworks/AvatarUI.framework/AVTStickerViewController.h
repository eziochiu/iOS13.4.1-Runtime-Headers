...
@interface AVTStickerViewController : UIViewController <AVTAvatarPickerDelegate, AVTAvatarRecordDataSourceObserver, AVTObjectViewController, AVTPaddleViewDelegate, AVTPresenterDelegate, AVTStickerPagingControllerDelegate> {
    bool  _allowEditing;
    bool  _allowPeel;
...
@property (nonatomic, readonly) bool allowEditing;
