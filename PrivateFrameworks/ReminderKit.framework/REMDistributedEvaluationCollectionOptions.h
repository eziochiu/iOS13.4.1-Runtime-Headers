...
@property (nonatomic) bool includeReminderTitleCategoryClosestWord;
@property (nonatomic) bool includeReminderTitleCategoryIntentionalWord;
@property (nonatomic) bool includeReminderTitleCategorySentenceAverage;
