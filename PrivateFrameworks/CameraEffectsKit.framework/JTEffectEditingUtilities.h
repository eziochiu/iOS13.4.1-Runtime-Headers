...
+ (struct CGPoint { double x1; double x2; })CFX_originAfterApplyingCenteredCropOnPoint:(struct CGPoint { double x1; double x2; })arg1 outerSize:(struct CGSize { double x1; double x2; })arg2 innerSize:(struct CGSize { double x1; double x2; })arg3;
