...
- (bool)JT_isPoint:(struct CGPoint { double x1; double x2; })arg1 inPolyWithPoints:(struct CGPoint { double x1; double x2; }*)arg2 numPoints:(unsigned int)arg3 withMinimumOverlaySize:(struct CGSize { double x1; double x2; })arg4;
- (id)JT_viewInfoForViewBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 time:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 isPosterFrame:(bool)arg3 includeDropShadow:(bool)arg4;
...
- (bool)hitTest:(struct CGPoint { double x1; double x2; })arg1 time:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 relativeTo:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3 basisOrigin:(int)arg4 withMinimumOverlaySize:(struct CGSize { double x1; double x2; })arg5;
