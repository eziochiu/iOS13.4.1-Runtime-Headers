...
@interface CKDetailsSearchViewController : CKSearchViewController <CKContainerSearchControllerDelegate, CKDetailsSearchResultsFooterCellDelegate, QLPreviewControllerDelegate> {
