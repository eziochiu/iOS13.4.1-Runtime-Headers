...
@interface CKRecipientSelectionController : CKViewController <CKComposeRecipientViewDelegate, CKRecipientSearchListControllerDelegate, CNAutocompleteGroupDetailViewControllerDelegate, CNComposeRecipientTextViewDelegate, CNContactPickerDelegate> {
