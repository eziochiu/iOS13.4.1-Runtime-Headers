...
+ (id)resourceObjectWithData:(id)arg1 sourceURL:(id)arg2 FHIRVersion:(id)arg3 receivedDate:(id)arg4 extractionHints:(unsigned long long)arg5 originVersion:(struct { long long x1; long long x2; long long x3; })arg6 originBuild:(id)arg7 country:(id)arg8 error:(id*)arg9;
