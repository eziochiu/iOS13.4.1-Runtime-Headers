...
@interface NCNotificationListCell : UIView <MTMaterialGrouping, NCNotificationViewControllerObserving, PLContentSizeCategoryAdjusting, UIGestureRecognizerDelegate, UIScrollViewDelegate> {
