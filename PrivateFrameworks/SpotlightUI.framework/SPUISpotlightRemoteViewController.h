...
@interface SPUISpotlightRemoteViewController : UIViewController <FBApplicationUpdateScenesTransactionObserver, FBProcessWatchdogProviding, FBSceneObserver, SBUIActiveOrientationObserver> {
