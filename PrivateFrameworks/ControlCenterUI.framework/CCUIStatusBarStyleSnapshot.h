...
@property (nonatomic, readonly, copy) _UIStatusBarData *leadingOverlayData;
...
- (id)initWithHidden:(bool)arg1 leadingStyleRequest:(id)arg2 trailingStyleRequest:(id)arg3 statusBarInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg4 avoidanceFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg5 leadingOverlayData:(id)arg6;
- (bool)isHidden;
- (id)leadingOverlayData;
