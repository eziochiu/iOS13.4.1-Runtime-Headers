...
@interface CCUIContentModuleContainerViewController : UIViewController <CCUIContentModuleContainer, CCUISafeAppearancePropagationProvider, UIGestureRecognizerDelegate, _UIClickPresentationInteractionDelegate, _UICursorInteractionDelegate> {
