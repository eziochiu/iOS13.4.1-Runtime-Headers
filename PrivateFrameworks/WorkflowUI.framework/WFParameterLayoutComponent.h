...
+ (id)newWithLabel:(id)arg1 labelsToAlignTo:(id)arg2 selectionAction:(struct CKTypedComponentAction<> { unsigned long long x1; id x2; id x3; SEL x4; })arg3 selectionEnabled:(bool)arg4 style:(const struct WFParameterLayoutComponentStyle { id x1; id x2; id x3; id x4; }*)arg5 accessibility:(const struct WFParameterLayoutComponentAccessibility { bool x1; id x2; id x3; id x4; unsigned long long x5; }*)arg6 controlResistance:(const struct WFCompressionResistance { int x1; double x2; }*)arg7 controlComponent:(id)arg8;
