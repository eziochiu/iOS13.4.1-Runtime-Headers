...
@interface WFAddToHomeScreenViewController : UITableViewController <UIDocumentPickerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, WFWorkflowWizardNameCellDelegate> {
