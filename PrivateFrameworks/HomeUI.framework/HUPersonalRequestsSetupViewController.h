...
@interface HUPersonalRequestsSetupViewController : HUImageOBWelcomeController <HFItemManagerDelegate, HUConfigurationViewController, HUItemTableModuleControllerHosting, HUPreloadableViewController> {
