...
@interface HUMediaSelectionViewController : HUItemTableViewController <HUSliderValueTableViewCellDelegate, HUSwitchCellDelegate, MPMediaPickerControllerDelegatePrivate> {
