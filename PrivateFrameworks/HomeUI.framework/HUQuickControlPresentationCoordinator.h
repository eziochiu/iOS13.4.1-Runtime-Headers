...
@interface HUQuickControlPresentationCoordinator : NSObject <HUCardViewControllerDelegate, HUPresentationDelegate, HUQuickControlContainerViewControllerDelegate, UIGestureRecognizerDelegate, UINavigationControllerDelegate, UIPresentationControllerDelegatePrivate, UITraitEnvironment, UIViewControllerTransitioningDelegate, _UIClickPresentationInteractionDelegate, _UISheetPresentationControllerDelegate> {
...
@property (nonatomic, retain) UIVisualEffectView *pressedTileBlurEffectView;
