...
- (void)readValueForCharacteristic:(id)arg1 timeout:(double)arg2 completionQueue:(id)arg3 logEventSession:(id)arg4 completionHandler:(id /* block */)arg5;
- (id)serialNumber;
- (id)server;
- (id)serverIdentifier;
- (id)services;
...
- (id)uniqueIdentifier;
- (id)workQueue;
- (void)writeCharacteristicValue:(id)arg1 timeout:(double)arg2 completionQueue:(id)arg3 logEventSession:(id)arg4 completionHandler:(id /* block */)arg5;
