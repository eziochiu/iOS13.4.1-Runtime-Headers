...
- (void)_readCharacteristicValues:(id)arg1 completionQueue:(id)arg2 logEventSession:(id)arg3 completionHandler:(id /* block */)arg4;
- (void)_readValueForCharacteristic:(id)arg1 completionQueue:(id)arg2 logEventSession:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)_writeCharacteristicValues:(id)arg1 queue:(id)arg2 logEventSession:(id)arg3 completionHandler:(id /* block */)arg4;
- (void)_writeValue:(id)arg1 forCharacteristic:(id)arg2 authorizationData:(id)arg3 logEventSession:(id)arg4 withCompletionHandler:(id /* block */)arg5 queue:(id)arg6;
