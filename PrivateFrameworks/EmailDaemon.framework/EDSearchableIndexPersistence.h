...
@property (nonatomic) struct os_unfair_lock_s { unsigned int x1; } lastProcessedAttachmentIDLock;
...
- (struct os_unfair_lock_s { unsigned int x1; })lastProcessedAttachmentIDLock;
...
- (void)setLastProcessedAttachmentIDLock:(struct os_unfair_lock_s { unsigned int x1; })arg1;
