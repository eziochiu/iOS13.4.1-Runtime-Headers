...
- (void)renderImageWithTargetSize:(struct CGSize { double x1; double x2; })arg1 contentMode:(long long)arg2 renderMode:(long long)arg3 renderTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg4 completion:(id /* block */)arg5;
