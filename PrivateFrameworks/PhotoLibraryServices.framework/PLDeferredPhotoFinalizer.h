...
- (void)enqueueAssetForFinalization:(id)arg1 forWide:(bool)arg2 withTaskIdentifier:(id)arg3 taskDidBeginHandler:(id /* block */)arg4 completionHandler:(id /* block */)arg5;
- (id)init;
...
- (void)requestFinalizationOfAsset:(id)arg1 forWide:(bool)arg2 completionHandler:(id /* block */)arg3;
