...
@interface PDPeerPaymentWebServiceCoordinator : NSObject <PDCloudStoreNotificationCoordinatorObserver, PDPushNotificationConsumer, PDScheduledActivityClient, PKPeerPaymentRegistrationDelegate> {
...
@property (nonatomic, retain) PDDeviceRegistrationServiceCoordinator *deviceRegistrationCoordinator;
...
- (id)deviceRegistrationCoordinator;
...
- (void)peformDeviceWithRegistrationURL:(id)arg1 pushToken:(id)arg2 forceReregister:(bool)arg3 completion:(id /* block */)arg4;
...
- (void)setDeviceRegistrationCoordinator:(id)arg1;
