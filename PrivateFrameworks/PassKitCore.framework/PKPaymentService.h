...
- (void)didReceiveSharingInvitationWithIdentifier:(id)arg1 groupIdentifier:(id)arg2 metadata:(id)arg3 withCompletion:(id /* block */)arg4;
...
- (void)removeSharingInvitationReceiptWithIdentifier:(id)arg1 onCredential:(id)arg2 withCompletion:(id /* block */)arg3;
