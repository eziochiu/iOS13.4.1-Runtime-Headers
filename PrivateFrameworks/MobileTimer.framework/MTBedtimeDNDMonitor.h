...
@interface MTBedtimeDNDMonitor : NSObject <DNDModeAssertionUpdateListener, MTAgentDiagnosticDelegate, MTBedtimeDNDStateMachineDelegate, MTBedtimeDNDStateMachineInfoProvider, MTSleepObserver, MTTimeObserver> {
...
@property (nonatomic, retain) MTBedtimeDNDStateMachine *stateMachine;
