...
@interface WDDocumentOverviewViewController : HKTableViewController <SKStoreProductViewControllerDelegate, WDAppSwooshTableViewCellDelegate, WDUserActivityResponder> {
    UIFont * _bodyFont;
...
@property (nonatomic, retain) WDAppSwooshTableViewCell *recommendedAppsCell;
...
- (id)profile;
- (id)recommendedAppsCell;
- (id)reportRowTypes;
- (id)sectionTypes;
- (void)setBodyFont:(id)arg1;
- (void)setRecommendedAppsCell:(id)arg1;
