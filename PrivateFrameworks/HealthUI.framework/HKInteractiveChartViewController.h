...
@interface HKInteractiveChartViewController : HKViewController <HKCurrentTimeViewDelegate, HKCurrentValueViewDataSourceValueRangeFormatter, HKGraphViewDelegate, HKInteractiveChartCurrentValueViewCallbacks, HKInteractiveChartCurrentValueViewDelegate, HKInteractiveChartCurrentValueViewHandler, HKLollipopDelegate, HKMonthViewControllerDelegate, HKSampleTypeDateRangeControllerObserver, UIGestureRecognizerDelegate> {
