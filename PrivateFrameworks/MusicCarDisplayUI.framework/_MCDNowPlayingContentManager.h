...
@interface _MCDNowPlayingContentManager : NSObject <CARSessionObserving, MCDNowPlayingContentManagerProtocol, MCDNowPlayingViewControllerDataSource, MCDNowPlayingViewControllerDelegate, MPRequestResponseControllerDelegate, UITableViewDataSource, UITableViewDelegate> {
