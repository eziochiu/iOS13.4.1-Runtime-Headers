...
@interface CACCorrectionsCandidateViewStyle : NSObject <TUICandidateViewStyle> {
    ...
    bool  _showOneMoreCandidateWhenMovingBackwards;
    bool  _showsIndex;
...
@property (nonatomic) bool showOneMoreCandidateWhenMovingBackwards;
...
- (void)setShowOneMoreCandidateWhenMovingBackwards:(bool)arg1;
...
- (bool)showOneMoreCandidateWhenMovingBackwards;
- (bool)showsIndex;
