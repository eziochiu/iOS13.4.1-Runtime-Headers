...
@interface WFVariable : NSObject <WFVariableSerialization, WFVariableStringContent> {
...
- (void)getContentWithContext:(id)arg1 trackContentSource:(bool)arg2 completionHandler:(id /* block */)arg3;
