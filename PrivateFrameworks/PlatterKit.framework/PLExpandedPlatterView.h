...
@interface PLExpandedPlatterView : UIView <PLContentSizeCategoryAdjusting, PLExpandedPlatter, PLTitled, UIGestureRecognizerDelegate, UIScrollViewDelegate, _UICursorInteractionDelegate> {
