...
- (id).cxx_construct;
- (void).cxx_destruct;
- (id)initWithProperties:(const struct vector<pxrInternal_v0_19__pxrReserved__usdkit__::UsdProperty, std::__1::allocator<pxrInternal_v0_19__pxrReserved__usdkit__::UsdProperty> > { struct UsdProperty {} *x1; struct UsdProperty {} *x2; struct __compressed_pair<pxrInternal_v0_19__pxrReserved__usdkit__::UsdProperty *, std::__1::allocator<pxrInternal_v0_19__pxrReserved__usdkit__::UsdProperty> > { struct UsdProperty {} *x_3_1_1; } x3; }*)arg1;
- (id)nextObject;
