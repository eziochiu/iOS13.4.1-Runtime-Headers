...
- (id)initWithVtValue:(struct VtValue { struct type { unsigned char x_1_1_1[8]; } x1; struct TfPointerAndBits<const pxrInternal_v0_19__pxrReserved__usdkit__::VtValue::_TypeInfo> { struct _TypeInfo {} *x_2_1_1; } x2; })arg1 typeName:(struct TfToken { struct TfPointerAndBits<const pxrInternal_v0_19__pxrReserved__usdkit__::TfToken::_Rep> { struct _Rep {} *x_1_1_1; } x1; })arg2;
...
- (void)setValue:(struct VtValue { struct type { unsigned char x_1_1_1[8]; } x1; struct TfPointerAndBits<const pxrInternal_v0_19__pxrReserved__usdkit__::VtValue::_TypeInfo> { struct _TypeInfo {} *x_2_1_1; } x2; })arg1;
- (id)stringArray;
- (id)stringValue;
- (id)timeCodeValue;
- (id)tokenArray;
...
- (id)urlValue;
- (struct VtValue { struct type { unsigned char x_1_1_1[8]; } x1; struct TfPointerAndBits<const pxrInternal_v0_19__pxrReserved__usdkit__::VtValue::_TypeInfo> { struct _TypeInfo {} *x_2_1_1; } x2; })value;
