...
- (void)_presentCredentialSetupViewControllerForPaymentPass:(id)arg1 invitation:(id)arg2 shouldRequestInvitation:(bool)arg3 completion:(id /* block */)arg4;
...
- (void)_refreshCredentialInvitationsWithCompletion:(id /* block */)arg1;
- (void)_refreshPasses;
