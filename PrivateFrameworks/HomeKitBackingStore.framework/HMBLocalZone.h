...
@property (nonatomic, readonly) NSMutableDictionary *observersByModelID;
...
- (id)fetchModels;
- (bool)fetchModelsAndChildModelsOfType:(Class)arg1 error:(id*)arg2 handler:(id /* block */)arg3;
