...
- (void)_refreshLocalStoreAccountPropertiesAllowingDidChangeNotification:(bool)arg1 completion:(id /* block */)arg2;
...
- (void)_saveIdentityProperties:(id)arg1 andPostAccountChangeNotification:(bool)arg2 forUserIdentity:(id)arg3 completionHandler:(id /* block */)arg4;
