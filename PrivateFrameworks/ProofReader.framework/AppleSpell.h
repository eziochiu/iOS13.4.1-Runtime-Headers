...
- (id)_accentCorrectionResultForString:(id)arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 inString:(id)arg3 offset:(unsigned long long)arg4 language:(id)arg5 onlyAtInsertionPoint:(bool)arg6 keyEventArray:(id)arg7 selectedRangeValue:(id)arg8;
