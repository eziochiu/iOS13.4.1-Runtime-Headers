...
+ (id)hb_compactConstraint:(id)arg1 metrics:(id)arg2 views:(id)arg3;
+ (id)hb_compactConstraint:(id)arg1 metrics:(id)arg2 views:(id)arg3 self:(id)arg4;
+ (id)hb_compactConstraints:(id)arg1 metrics:(id)arg2 views:(id)arg3;
+ (id)hb_compactConstraints:(id)arg1 metrics:(id)arg2 views:(id)arg3 self:(id)arg4;
+ (id)hb_identifiedConstraintsWithVisualFormat:(id)arg1 options:(unsigned long long)arg2 metrics:(id)arg3 views:(id)arg4;
