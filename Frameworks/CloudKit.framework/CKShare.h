...
- (void)_prepPCSDataWithContext:(id)arg1 databaseScope:(long long)arg2 publicSharingKey:(id)arg3 removeServerSpecifiedKeys:(bool)arg4 containerIdentifier:(id)arg5 completionHandler:(id /* block */)arg6;
- (void)_prepPCSDataWithContext:(id)arg1 databaseScope:(long long)arg2 publicSharingKey:(id)arg3 removeServerSpecifiedKeys:(bool)arg4 containerIdentifier:(id)arg5 sharedRecordZone:(id)arg6 completionHandler:(id /* block */)arg7;
