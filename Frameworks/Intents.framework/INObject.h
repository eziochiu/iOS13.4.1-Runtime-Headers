...
@interface INObject : NSObject <INJSONSerializable, INRuntimeObject, INSpeakable, NSCopying, NSSecureCoding, REDonatedActionIdentifierProviding, WFINObject, WFNaming> {
