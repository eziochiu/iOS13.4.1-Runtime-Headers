...
@interface MPIdentifierSet : NSObject <MPMutableIdentifierSet, MPMutableLocalLibraryIdentifiers, MPMutablePersonalStoreIdentifiers, MPMutableRadioIdentifiers, MPMutableUniversalStoreIdentifiers, NSCopying, NSSecureCoding, _MPStateDumpPropertyListTransformable> {
    long long  _adamID;
...
@property (nonatomic, readonly, copy) NSArray *formerAdamIDs;
...
@property (nonatomic, readonly, copy) NSString *universalCloudLibraryID;
