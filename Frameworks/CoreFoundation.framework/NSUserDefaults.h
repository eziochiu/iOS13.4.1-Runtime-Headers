...
@property (nonatomic) bool kAutoExportRoomPlan;
...
@property (nonatomic) bool kExportPreviewScene;
...
@property (nonatomic) bool kRoomBlackModeEnabled;
@property (nonatomic) bool kRoomCoachingEnabled;
@property (nonatomic) bool kRoomDebugMapEnabled;
@property (nonatomic) bool kRoomDebugTilesEnabled;
@property (nonatomic) float kRoomMaxDistanceRequired;
@property (nonatomic) float kRoomMaxPitch;
@property (nonatomic) float kRoomMaxSurfaceAngle;
@property (nonatomic) float kRoomMinPitch;
@property (nonatomic) float kRoomMinRotationalVelocity;
@property (nonatomic) float kRoomMinTranslationalVelocity;
@property (nonatomic) bool kRoomPlanTrueObjectScale;
@property (nonatomic) float kRoomScanAnimationDuration;
@property (nonatomic) long long kRoomScanAreaColor;
@property (nonatomic) long long kRoomScanEdgeColor;
@property (nonatomic) long long kRoomScanHeatColor;
@property (nonatomic) long long kRoomScanLightColor;
@property (nonatomic) float kRoomScanLightOffsetMagnitude;
@property (nonatomic) float kRoomScanLightOffsetSpeed;
@property (nonatomic) float kRoomScanNightGamma;
@property (nonatomic) long long kRoomScanPulseColor;
@property (nonatomic) float kRoomScanPulseSize;
@property (nonatomic) float kRoomScanPulseSpeed;
@property (nonatomic) float kRoomScanSharpness;
@property (nonatomic) bool kRoomShouldRenderWalls;
@property (nonatomic) bool kShouldDisableRoomScanOnboarding;
@property (nonatomic) bool kShouldReplayCustomFloorPlan;
@property (nonatomic) bool kShouldReportMeasurements;
@property (nonatomic) bool kShowFeaturePoints;
@property (nonatomic) bool kShowKeyFramePreview;
...
@property (nonatomic) bool kShowPreviewColors;
...
@property (nonatomic) bool logRoomScan;
...
- (bool)kRoomBlackModeEnabled;
- (bool)kRoomCoachingEnabled;
- (bool)kRoomDebugMapEnabled;
- (bool)kRoomDebugTilesEnabled;
- (float)kRoomMaxDistanceRequired;
- (float)kRoomMaxPitch;
- (float)kRoomMaxSurfaceAngle;
- (float)kRoomMinPitch;
- (float)kRoomMinRotationalVelocity;
- (float)kRoomMinTranslationalVelocity;
- (bool)kRoomPlanTrueObjectScale;
- (float)kRoomScanAnimationDuration;
- (long long)kRoomScanAreaColor;
- (long long)kRoomScanEdgeColor;
- (long long)kRoomScanHeatColor;
- (long long)kRoomScanLightColor;
- (float)kRoomScanLightOffsetMagnitude;
- (float)kRoomScanLightOffsetSpeed;
- (float)kRoomScanNightGamma;
- (long long)kRoomScanPulseColor;
- (float)kRoomScanPulseSize;
- (float)kRoomScanPulseSpeed;
- (float)kRoomScanSharpness;
- (bool)kRoomShouldRenderWalls;
- (bool)kShouldDisableRoomScanOnboarding;
- (bool)kShouldReplayCustomFloorPlan;
- (bool)kShouldReportMeasurements;
- (bool)kShowFeaturePoints;
- (bool)kShowKeyFramePreview;
- (bool)kShowLightIntensityDebugInfo;
- (bool)kShowOppositeUnits;
- (bool)kShowOverallState;
- (bool)kShowPreciseMeasurement;
- (bool)kShowPreviewColors;
...
- (void)setKAutoExportRoomPlan:(bool)arg1;
...
- (void)setKExportPreviewScene:(bool)arg1;
...
- (void)setKRoomBlackModeEnabled:(bool)arg1;
- (void)setKRoomCoachingEnabled:(bool)arg1;
- (void)setKRoomDebugMapEnabled:(bool)arg1;
- (void)setKRoomDebugTilesEnabled:(bool)arg1;
- (void)setKRoomMaxDistanceRequired:(float)arg1;
- (void)setKRoomMaxPitch:(float)arg1;
- (void)setKRoomMaxSurfaceAngle:(float)arg1;
- (void)setKRoomMinPitch:(float)arg1;
- (void)setKRoomMinRotationalVelocity:(float)arg1;
- (void)setKRoomMinTranslationalVelocity:(float)arg1;
- (void)setKRoomPlanTrueObjectScale:(bool)arg1;
- (void)setKRoomScanAnimationDuration:(float)arg1;
- (void)setKRoomScanAreaColor:(long long)arg1;
- (void)setKRoomScanEdgeColor:(long long)arg1;
- (void)setKRoomScanHeatColor:(long long)arg1;
- (void)setKRoomScanLightColor:(long long)arg1;
- (void)setKRoomScanLightOffsetMagnitude:(float)arg1;
- (void)setKRoomScanLightOffsetSpeed:(float)arg1;
- (void)setKRoomScanNightGamma:(float)arg1;
- (void)setKRoomScanPulseColor:(long long)arg1;
- (void)setKRoomScanPulseSize:(float)arg1;
- (void)setKRoomScanPulseSpeed:(float)arg1;
- (void)setKRoomScanSharpness:(float)arg1;
- (void)setKRoomShouldRenderWalls:(bool)arg1;
- (void)setKShouldDisableRoomScanOnboarding:(bool)arg1;
- (void)setKShouldReplayCustomFloorPlan:(bool)arg1;
- (void)setKShouldReportMeasurements:(bool)arg1;
- (void)setKShowFeaturePoints:(bool)arg1;
- (void)setKShowKeyFramePreview:(bool)arg1;
...
- (void)setKShowPreviewColors:(bool)arg1;
