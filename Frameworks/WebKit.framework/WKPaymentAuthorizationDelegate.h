...
- (id)_initWithRequest:(id)arg1 presenter:(struct PaymentAuthorizationPresenter { int (**x1)(); struct WeakPtrFactory<WebKit::PaymentAuthorizationPresenter> { struct RefPtr<WTF::WeakPtrImpl, WTF::DumbPtrTraits<WTF::WeakPtrImpl> > { struct WeakPtrImpl {} *x_1_2_1; } x_2_1_1; } x2; struct Client {} *x3; }*)arg2;
