...
- (void).cxx_destruct;
- (id)init;
- (id)initWithPoints:(const struct PKMetalPaintStrokePoint { float x1; unsigned int x2 : 4; unsigned int x3 : 28; }*)arg1 liveStrokePoints:(const struct PKMetalLiveStrokePaintStrokePoint { float x1; float x2; }*)arg2 numPoints:(unsigned long long)arg3 numVertices:(unsigned long long)arg4 resourceHandler:(id)arg5;
