...
@interface PKPaletteToolPreview : UIView <PKColorPickerDelegate, PKEdgeLocatable, PKPalettePopoverDismissing, PKPaletteViewSizeScaling, UIPopoverPresentationControllerDelegate> {
...
@property (nonatomic, retain) PKPaletteToolView *tool;
