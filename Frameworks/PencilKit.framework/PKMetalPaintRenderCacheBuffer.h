...
- (void).cxx_destruct;
- (id)init;
- (id)initWithUniforms:(const struct PKMetalPaintKernelUniforms { unsigned int x1; unsigned int x2; unsigned int x3; float x4; float x5; float x6; }*)arg1 points:(const struct PKMetalPaintStrokePoint { float x1; unsigned int x2 : 4; unsigned int x3 : 28; }*)arg2 numPoints:(unsigned long long)arg3 numVertices:(unsigned long long)arg4 resourceHandler:(id)arg5;
