...
- (void).cxx_destruct;
- (bool)__checkContextAndCompletionHandler:(id /* block */)arg1;
- (void)__sendMessage:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)updateProtectionMode:(long long)arg1 completionHandler:(id /* block */)arg2;
