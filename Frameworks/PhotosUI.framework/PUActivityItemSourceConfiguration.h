...
@property (nonatomic) struct { bool x1; bool x2; bool x3; } sharingPreferences;
...
- (id)initWithAsset:(id)arg1 availableSharingVariants:(id)arg2 activityType:(id)arg3 preferences:(struct { bool x1; bool x2; bool x3; })arg4;
