...
@property (nonatomic, readonly) struct { bool x1; bool x2; bool x3; } sharingPreferences;
...
- (id)initWithAsset:(id)arg1 sharingPreferences:(struct { bool x1; bool x2; bool x3; })arg2;
