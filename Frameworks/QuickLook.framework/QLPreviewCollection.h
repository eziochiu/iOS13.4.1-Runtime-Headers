...
@interface QLPreviewCollection : UIViewController <QLPageViewControllerDataSource, QLPageViewControllerDelegate, QLPreviewCollectionProtocol, QLPreviewItemViewControllerDelegate, QLTransitionControllerProtocol, UIGestureRecognizerDelegatePrivate> {
